        ...
        lgn_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isConnected()) {
                                ...
                                .addOnCompleteListener(teacher_login.this, new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            Toast.makeText(teacher_login.this, "Authentication success.", Toast.LENGTH_SHORT).show();
                                            startActivity(new Intent(teacher_login.this, teacher_home.class));
                                            finish();
                                        } else {
                    ...
                    Toast.makeText(teacher_login.this, "No internet connection.", Toast.LENGTH_SHORT).show();
                }
            }
        });
