...
public class parent_feedback extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        feedbackRef = FirebaseDatabase.getInstance().getReference().child("parent_feedback");
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(parent_feedback.this,parent_settings.class);
                ...
                userFeedbackRef.setValue(feedbackData)
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(parent_feedback.this, "Feedback submitted successfully", Toast.LENGTH_SHORT).show();
                            }
                        })
                        .addOnFailureListener(new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(parent_feedback.this, "Failed to submit feedback: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        } else {
